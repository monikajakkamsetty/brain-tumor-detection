...
# NOTE: Keras EfficientNetB0 has its own rescaling built in and expects raw
# 0-255 pixels. If your model is the EfficientNet transfer model and train.py
# did NOT divide by 255, change this to 1.0.
RESCALE = 1.0 / 255.0
...
#
# Loading is NOT started at import time: gunicorn imports this module in both
# the master and the worker process, which would load the model twice. It is
# started lazily from the routes instead, once per process.
# -----------------------------
_model = None
_model_error = None
